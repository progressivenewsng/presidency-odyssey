  ...
  return (
    <footer className="bg-slate-900 text-white mt-12 py-12">
      <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8">
        <div>
          <h2 className="text-xl font-serif font-bold mb-4"> <Image  src={logo} alt="Logo" className="inline object-contain" width={80} height={80}/></h2>
        ...
        <div>
          ...
          <div className="flex space-x-4">
            <a href="https://www.facebook.com/share/1LgMguZaZY/?mibextid=wwXIfr" target="_blank" className="w-8 h-8 rounded-full bg-gray-800 flex items-center justify-center hover:bg-orange-900 transition-all duration-300 hover:scale-110">
            ...
            <a href="https://x.com/progressivepgf?s=11" target="_blank" className="w-8 h-8 rounded-full bg-gray-800 flex items-center justify-center hover:bg-orange-900 transition-all duration-300 hover:scale-110">
